...
HdMap.prototype = {
    ...
    addPoints: function (points, html) {
        var jsons;
    ...
    addLine: function (lines, styleMap) {
        if (!styleMap) {
        ...
        for (var i = 0, j = lines.length; i < j; i++) {
            ...
            //var nbounds = new OpenLayers.Bounds(bounds.left*0.9995,bounds.bottom*1.0005,bounds.right*1.0008,bounds.top*1.0005);
